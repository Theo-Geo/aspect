...
namespace aspect
{
  ...
  namespace MaterialModel
  {
                                                      ...
                                                      const double L, const double M, const double N) const
    {
      ...
      AssertThrow(anisotropic_invariant > 0, ExcMessage(std::to_string(F) + "  " + std::to_string(G) + "  " + std::to_string(H) + "  " + std::to_string(L) + "  "+ std::to_string(M) + "  "+ std::to_string(N) + "  " + std::to_string(gamma) + "  " + std::to_string(anisotropic_invariant) + " anisotropic invariant is not positive. \nstrain rate components:" + std::to_string(strain_rate_cpo_frame[0][0])  + "  " + std::to_string(strain_rate_cpo_frame[1][1]) + "  " + std::to_string(strain_rate_cpo_frame[2][2]) + "  " + std::to_string(strain_rate_cpo_frame[1][2]) + "  " + std::to_string(strain_rate_cpo_frame[0][2]) + "  " + std::to_string(strain_rate_cpo_frame[0][1])));
          ...
          if  ((this->simulator_is_past_initialization()) && (this->get_timestep_number() > 0) && (std::isfinite(determinant(deviatoric_strain_rate))) && (anisotropic_viscosity != nullptr))
            {
              ...
              const double eigvalue_a3 = std::max(1 - eigvalue_a1 - eigvalue_a2, 1e-4);
              ...
              const double eigvalue_b3 = std::max(1 - eigvalue_b1 - eigvalue_b2, 1e-4);
              ...
              const double eigvalue_c3 = std::max(1 - eigvalue_c1 - eigvalue_c2, 1e-4);
              ...
              // CPO2Hill v3 model:
              const double F = std::min(1., std::max(1e-3, Utilities::fixed_power<2>(eigvalue_a1)*CnI_F[0] + eigvalue_a1*CnI_F[1] + eigvalue_a2*CnI_F[2] + (1/eigvalue_a3)*CnI_F[3] + Utilities::fixed_power<2>(eigvalue_b1)*CnI_F[4] + eigvalue_b1*CnI_F[5] + eigvalue_b2*CnI_F[6] + (1/eigvalue_b3)*CnI_F[7] + Utilities::fixed_power<2>(eigvalue_c1)*CnI_F[8] + eigvalue_c1*CnI_F[9] + eigvalue_c2*CnI_F[10] + (1/eigvalue_c3)*CnI_F[11] + CnI_F[12]));
              const double G = std::min(1., std::max(1e-3,Utilities::fixed_power<2>(eigvalue_a1)*CnI_G[0] + eigvalue_a1*CnI_G[1] + eigvalue_a2*CnI_G[2] + (1/eigvalue_a3)*CnI_G[3] + Utilities::fixed_power<2>(eigvalue_b1)*CnI_G[4] + eigvalue_b1*CnI_G[5] + eigvalue_b2*CnI_G[6] + (1/eigvalue_b3)*CnI_G[7] + Utilities::fixed_power<2>(eigvalue_c1)*CnI_G[8] + eigvalue_c1*CnI_G[9] + eigvalue_c2*CnI_G[10] + (1/eigvalue_c3)*CnI_G[11] + CnI_G[12]));
              const double H = std::min(1.,std::max(1e-3, Utilities::fixed_power<2>(eigvalue_a1)*CnI_H[0] + eigvalue_a1*CnI_H[1] + eigvalue_a2*CnI_H[2] + (1/eigvalue_a3)*CnI_H[3] + Utilities::fixed_power<2>(eigvalue_b1)*CnI_H[4] + eigvalue_b1*CnI_H[5] + eigvalue_b2*CnI_H[6] + (1/eigvalue_b3)*CnI_H[7] + Utilities::fixed_power<2>(eigvalue_c1)*CnI_H[8] + eigvalue_c1*CnI_H[9] + eigvalue_c2*CnI_H[10] + (1/eigvalue_c3)*CnI_H[11] + CnI_H[12]));
